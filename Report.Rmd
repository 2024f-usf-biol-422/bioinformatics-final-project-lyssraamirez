...
The PAWWS  was then converted into a sraRuntable to be able to call on in the code. R studio packages were utilized, including “vcfR”, “ggplot2”, “ggthemes”, “knitr” and “dplyr” were used to visualize the data. Figures and tables were generated to illustrate SNP distribution, population trends, temporal patterns, and relationships between variables. Chat Gpt was also used to write the code of figures in this study.
