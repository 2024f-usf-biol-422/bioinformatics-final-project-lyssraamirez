...
#Tables
```{r save-summary-table, echo=FALSE, message=FALSE, warning=FALSE}
...
png("summary_table_output.png", width = 10, height = 8, units = "in", res = 300)
grid.draw(tableGrob(summary_table))
dev.off()
