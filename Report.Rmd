...
The pipeline worked effortlessly due to the `Bash` [@GNUbash] and `Rstudio`[@RStudio2023] function scripts previously provided by Professor Zimmerman, University of San Francisco.
