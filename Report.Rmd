...
# Assuming the preprocessing steps are handled earlier in the report, and `params$sra_runtable_path` is accurate
data <- read.csv("data/00_sra_runtable/SraRunTable.csv")  # Adjust the path if needed
