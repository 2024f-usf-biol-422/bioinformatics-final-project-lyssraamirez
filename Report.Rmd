...
# Create the bar plot
snp_plot <- ggplot(gene_snp_summary, aes(x = reorder(gene, -total_snps), y = total_snps,
                             fill = gene)) +
...
# Save the plot to a file
ggsave(filename = "normalized_sequencing_coverage.png", plot = normalized_plot, width = 10, height = 8, dpi = 300)
```
...
# Save the plot to a file
ggsave(filename = "population_size_avg_spotlen.png", plot = avg_spotlen_plot, width = 10, height = 8, dpi = 300)
```
...
# Save the kable table output to a text file
output_file <- "output.txt"
write(capture.output(table_output), file = output_file)

# Optionally, print the table output to view in the console
print(table_output)
